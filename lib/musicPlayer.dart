...
class _musicPlayerState extends State<musicPlayer> {
  ...
  void initState() {
    ...
    currentSongName = songs[currentSongIndex1].songName;
    currentSongImage = songs[currentSongIndex1].imgUrl;
  ...
  String play() {
    String currentSong = songs[currentSongIndex1].musicUrl;
    String songName = songs[currentSongIndex1].songName;
    String songImage = songs[currentSongIndex1].imgUrl;
    setState(() {
  ...
  String nextSong() {
    setState(() {
      ...
      if (currentSongIndex1 >= songs.length) {
    ...
    return songs[currentSongIndex1].musicUrl;
  }
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: ValueListenableBuilder(
                            valueListenable: Hive.box('favorite2').listenable(),
                            builder: (BuildContext context, box2, child) {
                              return ValueListenableBuilder(
                                ...
                                builder: (context, box, child) {
                                  final isFavorite =
                                      box.get(currentSongIndex1) != null;
                                  return IconButton(
                                      onPressed: () async {
                                        ScaffoldMessenger.of(context)
                                            .clearSnackBars();
                                        if (isFavorite) {
                                          await box.delete(currentSongIndex1);
                                          //<-------some changes------>
                                          await box2.delete(currentSongIndex1);
                                          //<-------some changes------>
                                          ...
                                          await box.put(
                                              currentSongIndex1,
                                              songs[currentSongIndex1]
                                                  .songName);
                                          await box2.put(currentSongIndex1,
                                              songs[currentSongIndex1].imgUrl);
